            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="main_blog_details">
                        <img class="img-fluid" src="{{asset('images/blog/news-blog.jpg')}}" alt="">
                        <a href="#">
                        ...
                        <div class="user_details">
                            ...
                            <div class="float-right mt-sm-0 mt-3">
                                <div class="media">
                                    ...
                                    <div class="d-flex">
                                        <img src="{{asset('images/blog/user-img.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('images/blog/prev.jpg')}}"
                                            alt=""></a>
                                </div>
                                <div class="arrow">
                            ...
                            <div
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="{{asset('images/blog/next.jpg')}}"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="comments-area">
                        ...
                        <div class="comment-list left-padding">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{asset('images/blog/c3.jpg')}}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{asset('images/blog/c4.jpg')}}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{asset('images/blog/c5.jpg')}}" alt="">
                                    </div>
                                    <div class="desc">
